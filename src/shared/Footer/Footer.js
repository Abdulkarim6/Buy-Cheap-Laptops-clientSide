...
const Footer = () => {
    return (
        <footer className="flex flex-col justify-center items-center p-10  bg-neutral text-neutral-content rounded">
            ...
            <div className='mt-2'>
                <p>Copyright © 2022 - All right reserved by Cheap Buy laptops</p>
            </div>
        </footer>
    );
};
